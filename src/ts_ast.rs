...
impl Path {
    ...
    pub fn from_ident(s: Span, identifier: Ident) -> Path {
        Path { span: s, segments: vec![PathSegment::from_ident(identifier, s)] }
    }
...
impl PathSegment {
    pub fn from_ident(ident: Ident, span: Span) -> Self {
        PathSegment { identifier: ident, span, parameters: None }
    }
...
impl Default for Generics {
    ...
    fn default() -> Generics {
        Generics {
            params: Vec::new(),
            where_clause: WhereClause { id: DUMMY_NODE_ID, predicates: Vec::new(), span: DUMMY_SP },
            span: DUMMY_SP,
        }
    }
}
...
impl Arg {
    ...
    pub fn from_self(eself: ExplicitSelf, eself_ident: SpannedIdent) -> Arg {
        ...
        let infer_ty = P(Ty { id: DUMMY_NODE_ID, node: TyKind::ImplicitSelf, span });
        ...
        match eself.node {
            ...
            | SelfKind::Region(lt, mutbl) => arg(
                ...
                P(Ty {
                    id: DUMMY_NODE_ID,
                    node: TyKind::Rptr(lt, MutTy { ty: infer_ty, mutbl }),
                    span,
                }),
            ),
        }
